...
function Vehicle() {
    ...
    const images = [
        {id:0, value:vehicle.length === 1 && vehicle[0]['image1'] !== "" ? vehicle[0]['image1'] : img1},
        {id:1, value:vehicle.length === 1 && vehicle[0]['image2'] !== "" ? vehicle[0]['image2'] : img2},
        {id:2, value:vehicle.length === 1 && vehicle[0]['image3'] !== "" ? vehicle[0]['image3'] : img3},
        {id:3, value:vehicle.length === 1 && vehicle[0]['image4'] !== "" ? vehicle[0]['image4'] : img4}
    ]
