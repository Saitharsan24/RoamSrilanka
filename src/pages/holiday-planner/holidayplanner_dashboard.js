  ...
  return (
    <React.Fragment>
      ...
      <div className="d-flex w-100 gap-3 p-2 flex-column ms-5">
        <div className="d-flex col-12 gap-3 p-2 flex-lg-row flex-md-column flex-column">
          <a
           href="plannerPackage"
            ...
            style={{ backgroundColor: "#FFFFFF", borderRadius: "12px", color:"inherit" }}
          >
            <div className=" d-flex flex-column ">
          ...
          >
            <div className=" d-flex flex-column justify-content-between ">
              <p style={{ color: "#98A3B2", fontSize: "28px" }}>Update Fairs</p>
              <p style={{ fontSize: "15px", fontWeight: "bold" }}>
                Total Fairs - 20
              </p>
            </div>
        ...
        <div
          className="d-flex  col-12 flex-lg-row flex-md-column align-items-center 
             gap-2 flex-column"
        >
          <div
            style={{
