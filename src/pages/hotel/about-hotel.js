...
const AboutHotel = () => {
  ...
  return (
    <div className="d-flex flex-column w-100">
            ...
            >
              ...
              <div className="d-flex flex-column justify-content-evenly">
                <div className="d-flex flex-column">
                  ...
                  <p className="m-0 mx-2" style={{ fontSize: "13px" }}>
                    <Icon.Textarea size={15} /> {room.roomSize} sq ft
                  </p>
                  <p className="m-0 mx-2" style={{ fontSize: "13px" }}>
                    <Icon.PeopleFill size={15} /> Sleeps {room.occupancy}
                  </p>
                  <p className="m-0 mx-2" style={{ fontSize: "13px" }}>
                    <MdIcons.MdHorizontalSplit size={15} /> {room.noOfBeds}{" "}
                    Queen bed
                  </p>
                  <p
                    style={{
                ...
                <div className="d-flex flex-column justify-content-between me-1">
                  ...
                  <div className="d-flex flex-row justify-content-between my-1 mx-2">
                    <Link onClick={() => openModalSeeAll(room.roomId)}>
      ...
      <Modal hotelRooms={hotelRooms} show={isAllModalOpen} onHide={closeModalSeeAll}
      >
        ...
        <Modal.Body>
          {hotelRooms.find((room) => room.roomId === roomId) ? (
            <form onSubmit={handleDeleteRoom} method="POST">
              <input
                type="hidden"
                name="roomId"
                value={roomId}
      ...
      <Modal show={isAddModalOpen} onHide={closeModalAdd}>
        ...
        <Modal.Body>
          <form onSubmit={handleAddRoom} method="POST">
            <div
              className="d-flex flex-column overflow-y-scroll mx-2"
              style={{ height: "32rem", width: "29rem" }}
            >
      ...
      <Modal show={isEditModalOpen} onHide={closeModalEdit}>
        ...
        <Modal.Body>
          {hotelRooms.find((room) => room.roomId === roomId) ? (
          <form onSubmit={handleEditRoom} method="POST">
            <input
              type="hidden"
              name="roomId"
              value={roomId}
